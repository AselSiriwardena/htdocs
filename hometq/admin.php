...
if(isset($_POST['vehicalId'])){
	...
	$SQL="select prodId , prodName as 'pro', prodPicNameSmall , prodDescripShort , prodPrice from Product";
...
echo "</td>";
echo "<td style='border: 0px'>";
echo "<p><h5>".$arrayp['pro']."</h5>"; //display product name as contained in the array
